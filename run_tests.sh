...
for k_value in {2,4,8,16}; do 
    ...
    echo "FILE_NAME,K_NUM,VERTEX_NUM,EDGES_NUM,INSERTS,UPDATES,DELETES,R_AVG,DURATION,RESIDENT_MEM" > "$outfile_name"
...
echo "FILE_NAME,VERTEX_NUM,K_NUM,EDGES_NUM,INSERTS,UPDATES,DELETES,R_AVG,DURATION,RESIDENT_MEM" > "$outfile_name"
